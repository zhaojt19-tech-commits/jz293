...
# Here is cpa code — let me know if you have questions about it. For you, the gene would be like the “cell type” variable and z-slice is “dosage”. 
# I don’t think you have a “drug” equivalent, but Sheng/Zucks can correct me there.
...
#             print('taking adversary on', self.iteration)
            ...
            loss_term = (adversary_drugs_loss +
